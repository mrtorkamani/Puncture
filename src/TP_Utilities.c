...
/* output routine for derivs in BAM format */
{
  ...
  fprintf(fp, "# ny = %d\n",n2);
  fprintf(fp, "# nz = %d\n",n3);
  fprintf(fp, "bhmass = %e\n",params_get_real("par_m"));
  fprintf(fp, "bhy1 = %e\n",0.); //
  fprintf(fp, "bhz1 = %e\n",0.); //
  fprintf(fp, "bhpx = %e\n",params_get_real("par_P1")); // FIXME: might need rotation
  fprintf(fp, "bhpy = %e\n",params_get_real("par_P2"));
  fprintf(fp, "bhpz = %e\n",params_get_real("par_P3"));
  fprintf(fp, "bhsx = %e\n",params_get_real("par_S1")); // FIXME: might need rotation
  fprintf(fp, "bhsy = %e\n",params_get_real("par_S2"));
  fprintf(fp, "bhsz = %e\n",params_get_real("par_S3"));
  fprintf(fp, "bhy2 = %e\n",0.); //
  fprintf(fp, "bhz2 = %e\n",0.); //
