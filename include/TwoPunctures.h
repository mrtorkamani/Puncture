...
/* TP_CoordTransf.c */
void AB_To_RT (int nvar, double A, double B, double *R, double *T, derivs *U);
//void C_To_c (int nvar, double X, double R, double *x, double *r, double par_b, derivs *U);
void RT3_To_xyz (int nvar, double R, double T, double phi, double *x, double *y, double *z, derivs *U);
